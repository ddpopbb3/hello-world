...
<!-- Body Start -->
		...
		<br>
		<form method="post" name="reg" action="<%=request.getContextPath() %>/userRegister.do">
			...
			<tr>
				...
				<input maxlength="12" size="32" name="userid" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: rgb(0, 0, 0);" type="text">
